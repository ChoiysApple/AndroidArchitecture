...
import com.marchengraffiti.architecture.androidarchitecture.mvp.CountriesPresenter;
...
public class MVVMActivity extends AppCompatActivity {
    ...
    private CountriesViewModel viewModel;           //strong link to presenter (problem of MVP)
